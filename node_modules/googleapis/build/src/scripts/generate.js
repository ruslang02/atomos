...
var args = argv._;
var gen = new generator_1.Generator({ debug: debug, includePrivate: false });
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!args.length) return [3 /*break*/, 1];
                    args.forEach(function (url) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, gen.generateAPI(url)];
                                case 1:
                                    _a.sent();
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pify(rimraf)(path.join(__dirname, '../../../src/apis'))];
                case 2:
                    _a.sent();
                    console.log('Generating APIs...');
                    return [4 /*yield*/, gen.generateAllAPIs()];
                case 3:
                    _a.sent();
