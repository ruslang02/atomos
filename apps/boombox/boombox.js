...
appButton.menu = new Menu([{
  ...
  click: async function() {
    ...
    await fs.writeFile(url, playlist, 'utf-8');
    new Notification({
...
playlist.className = "col-4 px-0 py-2 border-right";
playlist.style.minWidth = "12rem";
playlist.style.maxWidth = "20rem";
let cover = document.createElement("section");
cover.className = "flex-grow-1 bg-white d-flex align-items-center justify-content-center";
