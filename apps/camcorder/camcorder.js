...
appButton.className = "btn btn-outline-primary d-flex p-1 mr-2 btn-sm mdi mdi-18px lh-18 mdi-camcorder border-0 rounded";
...
image.className = "bg-white flex-grow-1";
